...
import { Loader2, ArrowRight, CreditCard, Clock, Globe, Mail } from 'lucide-react';
...
export default function UploadPage() {
  ...
  const handleFileSelect = (selectedFile: File | null) => {
    ...
    if (selectedFile) {
      ...
      // Create a hidden video element to get duration
      const video = document.createElement('video');
      video.preload = 'metadata';
      video.onloadedmetadata = () => {
        window.URL.revokeObjectURL(video.src);
        const durationInMinutes = video.duration / 60;
        setDuration(Math.max(1, Math.ceil(durationInMinutes))); // Minimum 1 min, round up
  ...
  const totalCost = duration * PRICE_PER_MIN;
    ...
    <div className="min-h-[calc(100vh-64px-300px)] py-12 bg-gray-50">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-10">
          ...
          <p className="mt-2 text-gray-500">Get started by uploading the video you want to subtitle.</p>
        </div>
            ...
            <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-200">
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500 mt-1">We'll send the subtitle files here when ready.</p>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="bg-white p-6 rounded-2xl shadow-lg border border-gray-100 sticky top-24">
              ...
              <div className="space-y-4 mb-6">
                ...
                <div className="flex justify-between items-center text-sm">
                  ...
                  <span className="font-medium text-gray-900">₹{PRICE_PER_MIN}/min</span>
                </div>
              ...
              <button
                ...
                className="w-full flex items-center justify-center px-4 py-3 border border-transparent rounded-xl shadow-sm text-sm font-medium text-white bg-primary hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 disabled:opacity-50 disabled:cursor-not-allowed transition-all"
              >
                {isSubmitting ? (
